...
- [x] 3. Imaging storage service




  - [x] 3.1 Create ImagingStorageService
    ...
    - _Requirements: 6.5_
  - [x] 3.2 Write property test for file storage path structure
    - **Property 15: File storage path structure**
    - **Validates: Requirements 6.5**
  - [x] 3.3 Create file validation rules
...
- [x] 5. Permissions and policies
  - [x] 5.1 Add new permissions to seeder
...
- [x] 7. Radiology controllers
  - [x] 7.1 Create RadiologyController
  ...
  - [x] 7.2 Write property test for worklist sorting
    - **Property 10: Worklist sorting**
    - **Validates: Requirements 5.1**
  - [x] 7.3 Write property test for worklist filtering
    - **Property 11: Worklist filtering**
    - **Validates: Requirements 5.3**
  - [x] 7.4 Create ImagingAttachmentController
  ...
  - [x] 7.5 Write property test for completion requirements
    - **Property 13: Completion requires report**
    - **Property 14: Completion metadata**
    - **Validates: Requirements 6.3, 6.4**
  - [x] 7.6 Create Form Requests
  ...
  - [x] 7.7 Add routes for radiology
...
- [x] 9. Consultation imaging support
  - [x] 9.1 Update ConsultationLabOrderController
...
- [x] 11. Update sidebar navigation
  ...
  - [x] 11.2 Update SharedData types
    - Add radiology permissions to auth.permissions type
    - _Requirements: 2.4, 2.5_
  - [x] 11.3 Update HandleInertiaRequests middleware
    - Include radiology permissions in shared data
    - _Requirements: 2.4, 2.5_
  - [x] 11.4 Write property test for menu visibility
...
- [x] 13. Radiology worklist page
  - [x] 13.1 Create Radiology/Index.tsx
  ...
  - [x] 13.2 Create Radiology/Show.tsx
  ...
  - [x] 13.3 Create ImageUploadZone component
...
- [x] 15. Consultation investigations section
  - [x] 15.1 Create InvestigationsSection component
...
- [x] 17. External image upload
  - [x] 17.1 Create ExternalImageUploadDialog component
  ...
  - [x] 17.2 Add external upload button to InvestigationsSection
    - Button to open ExternalImageUploadDialog
    - Permission check for upload-external
    - _Requirements: 4.1_

- [x] 18. Image viewing components
  - [x] 18.1 Create ImageGallery component
    - Thumbnail grid display
    - Lightbox view on click
    - Navigation between images
    - Download button
    - _Requirements: 7.1, 7.2_
  - [x] 18.2 Create ImagingResultsModal component
  ...
  - [x] 18.3 Write property test for external indicator
    - **Property 16: External indicator display**
    - **Validates: Requirements 7.5**
  - [x] 18.4 Update ConsultationLabOrdersTable
...
- [x] 22. Migrate imaging data from Mittag
  - [x] 22.1 Create MigrateImagingFromMittag command
  ...
  - [x] 22.2 Migrate imaging results and files
    ...
    - _Requirements: Data migration_
  - [x] 22.3 Migrate imaging comments/reports
