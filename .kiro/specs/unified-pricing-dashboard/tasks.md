...
- [x] 1. Set up database and models





  - [x] 1.1 Create PricingChangeLog migration
...
- [x] 2. Create PricingDashboardService




  - [x] 2.1 Create service class with getPricingData method
  ...
  - [x] 2.3 Implement updateCashPrice method
...
- [x] 4. Implement export and import functionality





  - [x] 4.1 Implement exportToCsv method


    - Generate CSV with item name, code, category, cash price, insurance columns
    - Respect current filters
    - _Requirements: 7.1, 7.2, 7.3_
  - [x] 4.2 Write property test for export


    - **Property 10: Export contains all filtered data**
    - **Validates: Requirements 7.1, 7.2, 7.3**
  - [x] 4.3 Implement importFromFile method
  ...
  - [x] 4.4 Write property test for import matching


    - **Property 11: Import matches items by code**
    - **Validates: Requirements 8.2**
  - [x] 4.5 Write property test for import error handling


    - **Property 12: Import handles invalid rows gracefully**
    - **Validates: Requirements 8.5, 8.6**
  - [x] 4.6 Implement generateImportTemplate method
...
- [x] 5. Create controller and routes


  - [x] 5.1 Create PricingDashboardController
  ...
  - [x] 5.2 Create Form Request classes
    ...
    - _Requirements: 2.5_
  - [x] 5.3 Write property test for price validation

    - **Property 2: Price validation rejects invalid values**
    - **Validates: Requirements 2.5**

  - [x] 5.4 Register routes in admin routes file
    ...
    - _Requirements: All_
  - [x] 5.5 Create PricingDashboardPolicy
...
- [x] 7. Create frontend components
  ...
  - [x] 7.1 Create PricingDashboard/Index.tsx page
  ...
  - [x] 7.2 Create PricingTable component
...
- [x] 8. Add unmapped items filter and mapping link
  ...
  - [x] 8.1 Add "Unmapped Only" filter option
