...
- [ ] 1. Consolidate Reports into Analytics Dashboard
...
- [ ] 1.1 Create AnalyticsWidget reusable component
...
- [ ] 1.2 Transform Reports Index into Analytics Dashboard
...
- [ ] 1.3 Delete separate report pages
...
- [ ] 1.4 Update routes for Analytics Dashboard
...
- [ ] 1.5 Write tests for Analytics Dashboard
...
- [ ] 2. Merge Coverage Dashboard and Coverage Rules
...
- [ ] 2.1 Rename and enhance CoverageDashboard component
...
- [ ] 2.2 Enhance AddExceptionModal with tariff support
...
- [ ] 2.3 Update ExceptionList component
...
- [ ] 2.4 Update backend to handle tariff creation
...
- [ ] 2.5 Delete Coverage Rules pages
...
- [ ] 2.7 Update routes for unified Coverage Management
...
- [ ] 2.8 Write tests for Coverage Management
...
- [ ] 3.2 Delete KeyboardShortcutsHelp component
...
- [ ] 3.3 Delete QuickActionsMenu component
...
- [ ] 3.4 Simplify BulkImportModal integration
...
- [ ] 3.5 Clean up CoverageManagement component
  - Remove all references to deleted components
  - Simplify component structure
  - Update imports and exports
  - _Requirements: 3.1, 3.2, 3.3, 3.4_

- [ ] 3.6 Write tests for simplified interface
...
- [ ] 4.2 Update routing for direct access
...
- [ ] 4.3 Write tests for flattened navigation
...
- [ ] 5. Streamline Claims Vetting Workflow
...
- [ ] 5.1 Create ClaimsVettingPanel component
...
- [ ] 5.2 Integrate vetting panel into Claims list
...
- [ ] 5.3 Update Claims API for JSON responses
...
- [ ] 5.4 Simplify Claims filtering interface
...
- [ ] 5.5 Write tests for Claims vetting workflow
...
- [ ] 6. Simplify Coverage Dashboard UI
...
- [ ] 6.1 Simplify expanded card content
...
- [ ] 6.2 Add global search functionality
...
- [ ] 6.4 Write tests for UI improvements
...
- [ ] 7. Implement Smart Defaults for New Plans
...
- [ ] 7.1 Add default coverage rule creation
...
- [ ] 7.2 Enhance plan creation wizard
...
- [ ] 7.3 Write tests for smart defaults
...
- [ ] 9.4 Implement focus management
...
- [ ] 12.1 Format code with Laravel Pint
  - Run `vendor/bin/pint --dirty` on all modified PHP files
  - Fix any formatting issues
  - _Requirements: All_

- [ ] 12.2 Clean up frontend code
