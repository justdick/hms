...
class InsurancePlanResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'consultation_default' => $this->consultation_default,
            'drugs_default' => $this->drugs_default,
            'labs_default' => $this->labs_default,
            'procedures_default' => $this->procedures_default,
