...
class ReviewPrescriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'supply_reviews.*.reason' => ['required_if:supply_reviews.*.action,external,cancel', 'string', 'max:255'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'supply_reviews.*.reason.required_if' => 'Reason is required when marking as external or cancelled.',
        ];
    }
