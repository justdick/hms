        ...
        >
            ...
            <CardContent className={cn('pt-0', statusConfig.bgColor)}>
                <div className="space-y-2">
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={cn(
                                                ...
                                                index ===
                                                    trend.slice(-5).length - 1
                                                    ? statusConfig.textColor.replace(
                                                          'text-',
                                                          'bg-',
                                                      )
                    ...
                    {lastReading && (
                        <div className="border-t border-gray-200 pt-1 text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400">
                            Last: {lastReading}
                        </div>
                    )}

                    {alert && (
                        <div className="flex items-center gap-1 rounded bg-red-100 p-2 text-xs font-medium text-red-600 dark:bg-red-900/30 dark:text-red-400">
