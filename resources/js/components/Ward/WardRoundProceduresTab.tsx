import AsyncProcedureSearch, {
    Procedure,
} from '@/components/Consultation/AsyncProcedureSearch';
import TemplateRenderer, {
    TemplateVariable,
} from '@/components/Consultation/TemplateRenderer';
...
export default function WardRoundProceduresTab({
    ...
    const [viewProcedure, setViewProcedure] =
        useState<WardRoundProcedure | null>(null);
    ...
    const handleAddProcedure = () => {
        ...
        router.post(
            `/admissions/${admissionId}/ward-rounds/${wardRoundId}/procedures`,
            {
    ...
    const handleDeleteProcedure = (procedureId: number) => {
        ...
        router.delete(
            `/admissions/${admissionId}/ward-rounds/${wardRoundId}/procedures/${procedureId}`,
            {
                    ...
                    {procedures.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Add procedures performed during this ward round
                            </p>
                        </div>
                    ) : (
                        <Table>
