...
export default function TariffEdit({ tariff, plans }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        insurance_plan_id: tariff.insurance_plan_id.toString(),
        item_type: tariff.item_type,
        item_code: tariff.item_code,
        item_description: tariff.item_description || '',
        standard_price: tariff.standard_price,
        insurance_tariff: tariff.insurance_tariff,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/insurance/tariffs/${tariff.id}`);
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit Tariff', href: '' },
            ]}
        >
            <Head title="Edit Insurance Tariff" />
