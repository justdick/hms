...
import type { NhisTariff } from './columns';
...
export function NhisTariffsDataTable<TData extends NhisTariff, TValue>({
    columns,
    data,
    pagination,
    filters,
    ...
    const handleActiveOnlyChange = (checked: boolean) => {
        ...
        router.get(
            '/admin/nhis-tariffs',
            { ...filters, active_only: checked || undefined },
            { preserveState: true, preserveScroll: true },
        );
    };
    ...
    const hasActiveFilters =
        filters.category || filters.search || filters.active_only;
                ...
                <div className="flex items-center gap-2">
                    <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                            handleActiveOnlyChange(checked === true)
                        }
                    />
                    <Label
                        htmlFor="active_only"
