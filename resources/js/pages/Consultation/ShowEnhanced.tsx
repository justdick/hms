...
export default function ConsultationShowEnhanced({
    ...
    const patientAge = calculateAge(
        consultation.patient_checkin.patient.date_of_birth,
    );
    const patientInfo = {
        age: patientAge,
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <div className="mt-4 grid grid-cols-1 gap-4 text-sm text-gray-600 md:grid-cols-3 dark:text-gray-400">
                                    <div>
                                        <p>
                                                ...
                                                (order) => (
                                                    ...
                                                    >
                                                        ...
                                                        {order.special_instructions && (
                                                            <p className="mt-2 rounded bg-yellow-50 p-2 text-sm text-gray-700 dark:bg-yellow-900/30 dark:text-gray-300">
                                                                <strong>
                                                                    Instructions:
                                                                </strong>{' '}
                                                                {
                                            ...
                                            (prescription) => (
                                                ...
                                                >
                                                    ...
                                                    {prescription.instructions && (
                                                        <p className="mt-2 rounded bg-blue-50 p-2 text-sm text-gray-700 dark:bg-blue-900/30 dark:text-gray-300">
                                                            <strong>
                                                                Instructions:
                                                            </strong>{' '}
                                                            {
